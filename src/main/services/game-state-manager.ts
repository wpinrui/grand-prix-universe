 ...
 */
function generateNegotiationUpdateEmail(
  state: GameState,
...
function applyTurnResult(state: GameState, result: TurnProcessingResult): boolean {
  ...
  return playerHadDesignMilestone || playerHadTestCompletion || playerHadReadyPart || negotiationStopped || playerReceivedManufacturerOutreach || playerReceivedDriverOutreach || playerReceivedStaffOutreach;
}
